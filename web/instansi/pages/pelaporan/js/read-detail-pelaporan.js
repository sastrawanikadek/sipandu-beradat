...
const readDetailPelaporan = async () => {
  ...
  if (emergency_status == 1 && jenis_krama == 1) {
    link = `https://sipanduberadat.com/api/pelaporan-darurat-tamu/find/?id_pelaporan_darurat_tamu=${id}&id_desa=${idDesa}`;
  } else if (emergency_status == 0 && jenis_krama == 1) {
    link = `https://sipanduberadat.com/api/pelaporan-tamu/find/?id_pelaporan_tamu=${id}&id_desa=${idDesa}`;
  } else if (emergency_status == 1 && jenis_krama == 0) {
    link = `https://sipanduberadat.com/api/pelaporan-darurat/find/?id_pelaporan_darurat=${id}&id_desa=${idDesa}`;
  } else if (emergency_status == 0 && jenis_krama == 0) {
    link = `https://sipanduberadat.com/api/pelaporan/find/?id_pelaporan=${id}&id_desa=${idDesa}`;
  }
  ...
  if (status_code === 200) {
    ...
    if (data.jenis_pelaporan.emergency_status === 1 && data.status === 0) {
      $("#form-photo").hide();
    }
