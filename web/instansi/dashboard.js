...
const readPelaporanDarurat = async () => {
  ...
  const req = await fetch(
    `https://sipanduberadat.com/api/pelaporan-darurat/?id_instansi=${idInstansi}`
  );
...
const readPelaporan = async () => {
  const idInstansi = localStorage.getItem("id_instansi");
  const req = await fetch(
    `https://sipanduberadat.com/api/pelaporan/?id_instansi=${idInstansi}`
  );
  const { status_code, data } = await req.json();
...
const readPelaporanTamu = async () => {
  const idInstansi = localStorage.getItem("id_instansi");
  const req = await fetch(
    `https://sipanduberadat.com/api/pelaporan-tamu/?id_instansi=${idInstansi}`
  );
  const { status_code, data } = await req.json();
...
const readPelaporanDaruratTamu = async () => {
  const idInstansi = localStorage.getItem("id_instansi");
  const req = await fetch(
    `https://sipanduberadat.com/api/pelaporan-darurat-tamu/?id_instansi=${idInstansi}`
  );
  const { status_code, data } = await req.json();
...
const totalAnalytics = async () => {
  const idInstansi = localStorage.getItem("id_instansi");
  const req = await fetch(
    `https://sipanduberadat.com/api/admin-instansi/analytic/?id_instansi=${idInstansi}`,
    {
      method: "GET",
    }
  );
  ...
  if (status_code === 200) {
    $("#jumlah-petugas").html(data.total_petugas);
    $("#jumlah-pelaporan-darurat").html(data.total_pelaporan_darurat);
    $("#jumlah-pelaporan-keluhan").html(data.total_pelaporan);
    $("#total-today-pelaporan").html(data.total_pelaporan + data.total_pelaporan_darurat);
