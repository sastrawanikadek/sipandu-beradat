<?php
    ...
    $mysqli = connect_db();
    $query = "SELECT pt.id, pt.password FROM petugas pt WHERE pt.status_aktif = 1 AND pt.username = ?";
    ...
    $tokens = generate_jwt_token($user_id, "petugas");
    ...
    $query = "INSERT INTO access_token_petugas VALUES (NULL, ?, ?, ?)";
    $stmt = $mysqli->prepare($query);
    ...
    $query = "INSERT INTO refresh_token_petugas VALUES (NULL, ?, ?)";
    $stmt = $mysqli->prepare($query);
