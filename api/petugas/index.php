<?php
    ...
    $mysqli = connect_db();
    $query = "
        SELECT pt.id, ip.id, kec.id, kab.id, p.id, n.id, n.nama, n.bendera, n.status_aktif, p.nama, 
            ...
            ip.status_aktif, pt.nama, pt.email, pt.nik, pt.avatar, pt.no_telp, pt.tanggal_lahir, 
    ...
    $stmt->bind_result($id, $instansi_id, $kecamatan_id, $kabupaten_id, 
        ...
        $instansi_report_status, $instansi_active_status, $name, $email, $nik, 
