<?php
    ...
    $mysqli = connect_db();
    $query = "SELECT sa.id, sa.password FROM superadmin sa WHERE sa.username = ?";
    ...
    $tokens = generate_jwt_token($user_id, "superadmin");
    ...
    $query = "INSERT INTO access_token_superadmin VALUES (NULL, ?, ?, ?)";
    $stmt = $mysqli->prepare($query);
    ...
    $query = "INSERT INTO refresh_token_superadmin VALUES (NULL, ?, ?, ?)";
    $stmt = $mysqli->prepare($query);
