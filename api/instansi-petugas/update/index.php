<?php
    ...
    ";
    $stmt = $mysqli->prepare($query);
    $stmt->bind_param("ssss", $id_kecamatan, $id_jenis_instansi, $name, $id);
    ...
    ";
    $stmt = $mysqli->prepare($query);
    $stmt->bind_param("ssssss", $id_kecamatan, $id_jenis_instansi, $name, $report_status, $active_status, $id);
    ...
    $response = [
        ...
        "message" => "Data instansi petugas berhasil diubah"
    ];
    echo json_encode($response);