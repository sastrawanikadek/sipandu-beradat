<?php
    ...
    $query = "SELECT COUNT(*) FROM banjar b WHERE b.nama = ? AND b.id_desa = ?";
    $stmt = $mysqli->prepare($query);
    ...
    $query = "INSERT INTO banjar VALUES (NULL, ?, ?, 1)";
    $stmt = $mysqli->prepare($query);
    $stmt->bind_param("ss", $id_desa, $name);
    ...
    $response = [
        ...
        "message" => "Data banjar berhasil ditambahkan"
    ];
