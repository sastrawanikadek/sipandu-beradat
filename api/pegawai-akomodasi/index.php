<?php
    ...
    $mysqli = connect_db();
    $query = "
        SELECT pa.id, a.id, da.id, kec.id, kab.id, p.id, n.id, n.nama, n.bendera, n.status_aktif, p.nama, 
            ...
            a.deskripsi, a.logo, a.nama, a.alamat, a.status_aktif, pa.nama, 
            pa.avatar, pa.no_telp, pa.tanggal_lahir, pa.nik, pa.jenis_kelamin, pa.status_aktif
    ...
    $stmt->bind_result($id, $akomodasi_id, $desa_adat_id, $kecamatan_id, 
        ...
        $name, $avatar, $phone, $date_of_birth, $nik, $gender, $active_status);
    ...
    $response = [
        "status_code" => 200,
        "data" => $data,
        "message" => "Data pegawai akomodasi berhasil diperoleh"
    ];
