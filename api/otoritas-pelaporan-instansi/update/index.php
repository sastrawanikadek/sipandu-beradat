<?php
    ...
    ";
    $stmt = $mysqli->prepare($query);
    $stmt->bind_param("sss", $id_instansi, $id_jenis_pelaporan, $id);
    ...
    $query = "
        UPDATE otoritas_pelaporan_instansi opi
        SET opi.id_instansi = ?,
            opi.id_jenis_pelaporan = ?
        WHERE opi.id = ?
    ";
    $stmt = $mysqli->prepare($query);
    $stmt->bind_param("sss", $id_instansi, $id_jenis_pelaporan, $id);
    ...
    $response = [
        ...
        "message" => "Data otoritas pelaporan instansi berhasil diubah"
    ];
    echo json_encode($response);