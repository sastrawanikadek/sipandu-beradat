<?php
    ...
    if (!(isset($_POST["id_pecalang"]) && $_POST["id_pecalang"] && 
        isset($_POST["holiday_status"]) && isset($_POST["days"]) && 
        gettype(json_decode($_POST["days"])) == "array")) {
        $response = [
            "status_code" => 400,
            "data" => null,
    ...
    $mysqli = connect_db();
    $pecalang_ids = [$_POST["id_pecalang"]];
    ...
    $response = [
        "status_code" => 200,
        "data" => null,
        "message" => "Data jadwal pecalang desa adat berhasil diubah"
    ];
