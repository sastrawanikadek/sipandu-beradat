<?php
    ...
    $query = "
        SELECT pl.id, m.id, b.id, da.id, kec.id, kab.id, p.id, n.id, n.nama, n.bendera, n.status_aktif, 
    ...
    if (isset($_GET["id_masyarakat"])) {
        $query .= " AND pl.id_masyarakat = ?";
        array_push($params, $_GET["id_masyarakat"]);
    }
    
    if (isset($_GET["id_desa"])) {
        $query .= " AND pl.id_desa = ?";
        array_push($params, $_GET["id_desa"]);
    }
    
    if (isset($_GET["id_jenis_pelaporan"])) {
        $query .= " AND pl.id_jenis_pelaporan = ?";
    ...
    $stmt->store_result();
    $stmt->bind_result($id, $masyarakat_id, $banjar_id, $desa_adat_id, $kecamatan_id, 
