...
class NegaraArrayAdapter(
        private val ctx: Context,
        private val items: List<Negara>,
        private val resourceId: Int = R.layout.layout_item_list
): ArrayAdapter<Negara>(ctx, resourceId, items) {

    private var filteredItems: List<Negara> = items
    ...
    override fun getItem(position: Int): Negara {
    ...
    override fun getFilter(): Filter {
        return object: Filter() {
            ...
            override fun publishResults(p0: CharSequence?, p1: FilterResults?) {
                filteredItems = p1?.values as List<Negara>
