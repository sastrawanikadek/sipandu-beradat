...
import com.sipanduberadat.guest.adapters.FamilyAdapter
...
class FamilyFragment: Fragment() {
    ...
    private val filteredFamilies: MutableList<KerabatTamu> = mutableListOf()
            ...
            if (viewModel.families.value != null && view.recycler_view.adapter != null) {
                if (text != null && text.isNotBlank()) {
                    ...
                    filteredFamilies.addAll(viewModel.families.value!!.filter {
                        it.tamu.name.contains("$text", true)
                    })
                    ...
                    if (filteredFamilies.size > 0) {
                        ...
                        val totalText = "${filteredFamilies.size} of ${viewModel.families.value!!.size} total family"
