...
import com.sipanduberadat.guest.services.apis.sendOTPAPI
import com.sipanduberadat.guest.services.apis.verifyOTPAPI
...
class VerifyCodeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        runnable = object : Runnable {
            override fun run() {
                if (Calendar.getInstance().timeInMillis < getRetryTime().timeInMillis) {
                    countdown.text = getTimeCountdown(
        ...
        btn_resend.setOnClickListener {
            sendOTPAPI(
                root, this, requestParams, HashMap(),
