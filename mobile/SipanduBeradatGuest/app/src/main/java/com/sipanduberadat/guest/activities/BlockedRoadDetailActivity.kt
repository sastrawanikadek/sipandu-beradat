...
import com.sipanduberadat.guest.utils.getTimeCountdown
...
class BlockedRoadDetailActivity : AppCompatActivity() {
    ...
    private val statusTitles = listOf("Not Started", "On Going", "Finish")
    private val statusDescriptions = listOf("This road closure will take effect in",
        "This road closure will end in", "This road closure has been finished from")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        map_container.layoutParams = LinearLayout.LayoutParams(
