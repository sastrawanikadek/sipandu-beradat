...
class JenisPelaporanArrayAdapter(
    private val ctx: Context,
    private val items: List<JenisPelaporan>,
    private val resourceId: Int = R.layout.layout_item_list
): ArrayAdapter<JenisPelaporan>(ctx, resourceId, items) {

    private var filteredItems: List<JenisPelaporan> = items
    ...
    override fun getItem(position: Int): JenisPelaporan? {
    ...
    override fun getFilter(): Filter {
        return object: Filter() {
            ...
            override fun publishResults(p0: CharSequence?, p1: FilterResults?) {
                filteredItems = p1?.values as List<JenisPelaporan>
