...
fun validateTamuEmergencyReportAPI(contextView: View, context: Context, requestParams: HashMap<String, String>,
    ...
    if (accessToken != null) {
        ...
        VolleyMultipartRequest(context, Request.Method.POST,
                "${Constants.BASE_URL}/pelaporan-darurat-tamu/validate/", requestParams,
                fileRequestParams, {
            val dataString = getResponseData(it, contextView, context, requestParams,
                    fileRequestParams, callback, errorCallback, ::validateTamuEmergencyReportAPI, showMessage)
