...
import com.sipanduberadat.user.adapters.NotificationAdapter
import com.sipanduberadat.user.models.Me
import com.sipanduberadat.user.models.Notifikasi
import com.sipanduberadat.user.services.apis.findAllNotificationAPI
    ...
    private fun onSuccessNotification(response: Any?) {
        if (response != null) {
            ...
            if (data.isEmpty()) {
                ...
                recycler_view.visibility = View.VISIBLE
                recycler_view.adapter = NotificationAdapter(this, data, me)
            }
        }
    }
