...
import com.sipanduberadat.user.adapters.ReportAdapter
import com.sipanduberadat.user.dialogs.FilterBottomSheetDialog
...
import com.sipanduberadat.user.viewModels.ReportViewModel
...
class UnhandleReportFragment: Fragment() {
    ...
    private fun onFilterReport(wrapper: ReportWrapper): Boolean {
        ...
        val reportStatusStatus = if (wrapper.report != null) wrapper.report!!.status == 0 else
            wrapper.guestReport!!.status == 0
        ...
        if (mainViewModel.me.value != null) {
            handledStatus = if (wrapper.report != null) wrapper.report!!.pecalang_reports.any {
                it.pecalang.id == mainViewModel.me.value!!.pecalang!!.id } else
                    wrapper.guestReport!!.pecalang_reports.any {
                        it.pecalang.id == mainViewModel.me.value!!.pecalang!!.id }
        }
