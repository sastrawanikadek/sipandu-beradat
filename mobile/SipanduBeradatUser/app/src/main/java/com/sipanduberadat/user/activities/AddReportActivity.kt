...
import com.sipanduberadat.user.adapters.JenisPelaporanArrayAdapter
import com.sipanduberadat.user.models.JenisPelaporan
import com.sipanduberadat.user.services.FileDataPart
import com.sipanduberadat.user.services.apis.createNotEmergencyReportAPI
import com.sipanduberadat.user.services.apis.findAllJenisPelaporanAPI
...
class AddReportActivity : AppCompatActivity() {
    ...
    private fun onReport() {
        ...
        if (reportType == (-1).toLong()) {
            btn_report.stopProgress()
            report_type_input_layout.helperText = "Jenis keluhan tidak boleh kosong"
        ...
        if (reportTitle.isBlank()) {
            btn_report.stopProgress()
            title_input_layout.helperText = "Judul keluhan tidak boleh kosong"
        ...
        if (reportDescription.isBlank()) {
            btn_report.stopProgress()
            description_input_layout.helperText = "Keterangan keluhan tidak boleh kosong"
        ...
        if (photoByteArray == null) {
            btn_report.stopProgress()
            snackbarWarning(root, "Foto keluhan tidak boleh kosong",
