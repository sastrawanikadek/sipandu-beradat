...
import com.sipanduberadat.user.dialogs.EmailBottomSheetDialog
import com.sipanduberadat.user.models.Token
import com.sipanduberadat.user.services.apis.fcmTokenAPI
import com.sipanduberadat.user.services.apis.loginAPI
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_forgot.setOnClickListener {
            EmailBottomSheetDialog().show(supportFragmentManager, "EMAIL_BOTTOM_SHEET")
        }
