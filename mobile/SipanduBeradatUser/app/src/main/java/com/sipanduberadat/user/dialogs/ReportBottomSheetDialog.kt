...
import com.sipanduberadat.user.services.apis.validateEmergencyReportAPI
import com.sipanduberadat.user.services.apis.validateNotEmergencyReportAPI
import com.sipanduberadat.user.services.apis.validateTamuEmergencyReportAPI
import com.sipanduberadat.user.services.apis.validateTamuNotEmergencyReportAPI
        ...
        when {
            viewModel.report.value != null -> {
                ...
                if (viewModel.guestReport.value!!.jenis_pelaporan.emergency_status) {
                    ...
                    validateTamuEmergencyReportAPI(activity!!.root, view!!.context, requestParams,
                            fileRequestParams, this::onSuccessValidate, this::onRequestError)
                } else {
                    val requestParams = HashMap<String, String>()
                    requestParams["id_pecalang"] = "${me.pecalang!!.id}"
                    ...
                    validateTamuNotEmergencyReportAPI(activity!!.root, view!!.context, requestParams,
                            fileRequestParams, this::onSuccessValidate, this::onRequestError)
                }
            }
        }
